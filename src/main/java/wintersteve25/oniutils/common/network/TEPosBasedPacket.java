...
public class TEPosBasedPacket {
    ...
    public TEPosBasedPacket(BlockEntity teIn, byte packetType) {
        this.pos = teIn.getBlockPos();
        this.packetType = packetType;
        this.thresholdValue = 0;
    }

    public TEPosBasedPacket(BlockEntity teIn, byte packetType, int thresholdValueIn) {
        this.pos = teIn.getBlockPos();
        this.packetType = packetType;
        this.thresholdValue = thresholdValueIn;
    }

    public TEPosBasedPacket(FriendlyByteBuf buffer) {
