...
public class ONIBlocks {
    ...
    public static final ONIBaseRock Algae = new ONIBaseRock(1, 4, 10, "Algae", SoundType.HARD_CROP);
    ...
    static {
        SedimentaryRock.initRock(SedimentaryRock);
        MaficRock.initRock(MaficRock);
        //Regolith.initRock(Regolith);
        //Neutronium.initRock(Neutronium);
        //Fossil.initRock(Fossil);
        BleachStone.initRock(BleachStone);
        //Rust.initRock(Rust);
        //PollutedIce.initRock(PollutedIce);
        Algae.initRock(Algae);
        //Phosphorite.initRock(Phosphorite);
        //Oxylite.initRock(Oxylite);
        Fertilizer.initRock(Fertilizer);
        GoldAmalgam.initRock(GoldAmalgam);
        Wolframite.initRock(Wolframite);
        //Abyssalite.initRock(Abyssalite);
    }
