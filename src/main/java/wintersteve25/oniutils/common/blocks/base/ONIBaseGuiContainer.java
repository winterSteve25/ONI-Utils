...
public class ONIBaseGuiContainer<T extends Container> extends ContainerScreen<T> {
    ...
    protected void powerToolTip(MatrixStack matrixStack, int power, int mouseX, int mouseY, int i, int j, int cord1, int cord1Y, int cord2, int cord2Y) {
