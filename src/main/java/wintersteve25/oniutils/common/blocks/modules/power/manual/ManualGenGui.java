...
@OnlyIn(Dist.CLIENT)
public class ManualGenGui extends ONIBaseGuiContainer<ManualGenContainer> {
    private static ResourceLocation bg = new ResourceLocation(ONIUtils.MODID, "textures/gui/machines/manual_gen_gui.png");

    public ManualGenGui(ManualGenContainer container, PlayerInventory inv, ITextComponent name) {
