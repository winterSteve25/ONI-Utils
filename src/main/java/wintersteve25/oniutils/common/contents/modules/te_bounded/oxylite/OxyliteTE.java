package wintersteve25.oniutils.common.contents.modules.te_bounded.oxylite;
        ...
        if (isServer()) {
            if (progress == -1) {
                ...
                chunk.getCapability(WorldGasCapability.WORLD_GAS_CAP).ifPresent((cap) -> {
                    cap.addGasToChunk(new GasStackWrapper(Element.getGasStackFromElement(Element.O, 2500)), getPos());
                    ...
                    if (MiscHelper.chanceHandling(10)) {
