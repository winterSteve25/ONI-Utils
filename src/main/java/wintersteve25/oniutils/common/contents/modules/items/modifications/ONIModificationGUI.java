...
public class ONIModificationGUI extends Screen {
    ...
    public void init(Minecraft minecraft, int width, int height) {
        ...
        SliderPercentageOption slider = new SliderPercentageOption("oniutils.gui.items.modification.bonus", -maxBonus, maxBonus, 1, gameSettings -> (double) bonus, (setting, value) -> bonus = value.intValue(), (gameSettings, sliderPercentageOption1) -> new TranslationTextComponent("oniutils.gui.items.modification.bonus", sliderPercentageOption1.get(gameSettings)));
